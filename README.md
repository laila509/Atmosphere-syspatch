大气层1.10.1集成sys-patch插件破解包v3-莱莱踢个球
=====

大气层1.10.1最高支持21.1.0系统，向下兼容支持21.0.1、19.0.1等低版本系统。

2025.12.24，大气层1.10.1破解包v3发布，可以在1.10.0/1.10.1的基础上覆盖升级，更新sys-patch-159英文，Lockpick_RCM.bin-1.9.17英文，Goldleaf.nro-1.2.0中文，DeepseaToolbox.nro-4.0.4英文。更新批处理脚本一键清理TF卡上旧的大气层破解包v4。

2025.12.13，大气层1.10.1破解包v2发布，可以在1.10.0/1.10.1的基础上覆盖升级，更新极限超频的loader.kip支持大气层1.10.1，更新Goldleaf.nro。
