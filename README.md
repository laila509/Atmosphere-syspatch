大气层1.10.3集成sys-patch插件破解包v0beta-莱莱踢个球
=====

大气层1.10.2最高支持21.2.0系统，向下兼容支持21.0.1、19.0.1等低版本系统，可以在莱莱之前发的破解包1.10.0/1.10.1/1.10.2的基础上覆盖升级。

大气层1.10.3破解包v0beta的组件非官方发布，并不支持22.0.0大气层真实系统或者22.0.0大气层虚拟系统。仅适用mariko型号的Switch正版系统误升22.0.0熔断后，支持ATM-Auto：大气层自动选择进入虚拟系统21.2.0或以下，正常使用，无休眠死机的bug，能玩破解游戏。只支持OFW-SYS：机身正版系统进入正版22.0.0，正常联机玩正版游戏。这个版本和上一个大气层破解包版本一样可以覆盖TF卡上升级，但是如果之前有极限超频的要手动删除loader.kip和还原hekate_ipl.ini，因为尚未更新，不兼容新系统。

！！只要正版系统没升级22.0.0的一律不需要更新大气层1.10.3破解包v0beta！！
